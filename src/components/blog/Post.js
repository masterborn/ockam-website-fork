...
const ShareButton = ({button: Button, url, children, ...rest}) => (<ShareButtonStyled><Button url={url} {...rest}>{children}</Button></ShareButtonStyled>);
        ...
        <PostContent>
          ...
          <SocialBox>
            ...
            <ShareButton button={LinkedinShareButton} url={url}>
              ...
              <Caption fontSize={1} ml={2} fontWeight={2}>LinkedIn</Caption>
            </ShareButton>
            <ShareButton button={TwitterShareButton} url={url}>
              <Icon icon={Twitter} />
              <Caption fontSize={1} ml={2} fontWeight={2}>Twitter</Caption>
            </ShareButton>
            <ShareButton button={FacebookShareButton}  url={url}>
              <Icon icon={FacebookSquare} />
              <Caption fontSize={1} ml={2} fontWeight={2}>Facebook</Caption>
            </ShareButton>
          </SocialBox>
        </PostContent>
      </BlogContent>
